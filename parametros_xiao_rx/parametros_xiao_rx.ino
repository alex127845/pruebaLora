...
// ✅ Configuración de pines para XIAO ESP32-S3 con módulo LoRa
#define LORA_CS   41    // SPI SS
#define LORA_RST  42    // Reset
#define LORA_BUSY 40    // Busy
#define LORA_DIO1 39    // DIO1 (IRQ)
#define LORA_MISO 8     // SPI MISO
#define LORA_MOSI 9     // SPI MOSI
#define LORA_SCK  7     // SPI SCK

// ✅ Pin adicional para control RF (RXEN)
#define LORA_RXEN 38    // RX Enable (DIO2)
...
// ✅ Inicializar SX1262 con pines correctos
...
void setup() {
  ...
  Serial.println("\n=== RECEPTOR LoRa XIAO ESP32-S3 + GATEWAY WEB v4 ===");

  // ✅ Configurar SPI manualmente con los pines correctos
  ...
  // Esto es específico del módulo XIAO con SX1262
...
void setupWebServer() {
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request){
    ...
    html += "<title>LoRa Gateway XIAO S3</title>";
    html += "<style>";
    ...
    html += "<h1>🛰️ LoRa Gateway XIAO ESP32-S3</h1>";
    
    // Info del dispositivo
    html += "<div class='device-info'>";
    html += "📟 <strong>XIAO ESP32-S3</strong> | 📡 <strong>SX1262</strong> | 📶 <strong>915 MHz</strong>";
    html += "</div>";
    
    // Configuración LoRa con ACK_EVERY
  ...
  // Configurar parámetros LoRa + ACK_EVERY
